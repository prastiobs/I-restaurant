...
$tampildatatabel = mysqli_query($connect, "SELECT * FROM `order` JOIN akun USING(username) JOIN produk USING(idProduk) WHERE statusOrder = 'lunas'") ;
    ...
    <div class="container">
      <div>
        <h2 class="site-tittle">
          <a style="float: left;" href="http://localhost/restaurant/IndexKoki.php"><img src="images/logo-restaurant.png" width="80" height="80"></a> <!-- LOGO TELKOM -->
        </h2>
      ...
      <nav class="navbar navbar-inverse col-md-12 col-sm-12 col-lg-12">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
              <li><a id="menunavbarnow" href="http://localhost/restaurant/LihatPesananPelanggan.php">Lihat Pesanan Pelanggan</a></li>
              <li><a id="menunavbar" href="http://localhost/restaurant/KelolaMenu.php">kelola Menu</a></li>
            </ul>
        ...
        <table class="table" id="tablemenu">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><button class="btn btn-sm btn-default" data-toggle="modal" data-target="#modalhapuspesanan<?= $row['idOrder'] ?>"><span class="glyphicon glyphicon-ok"></span> Sudah Dibuat</button></td>
            </tr>
            <!-- MODAL LUNAS ORDER -->
            <div class="modal fade" id="modalhapuspesanan<?= $row['idOrder'] ?>" role="dialog">
                ...
                <div class="modal-content">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="modal-body mx-3">
                        <h5 class="modal-title" id="exampleModalLabel">Apa anda yakin sudah membuat pesanan dari <strong><?= $row['firstName'] ?> <?= $row['lastName'] ?></strong> ini?</h5>
                        <br>
                        <h3><strong><center><?= $row['namaProduk'] ?></center></strong></h3>
                    </div>
                    ...
                    <div class="modal-footer">
                      <form method="POST" action="">
                        ...
                        <button type="submit" name="hapuspesanan" class="btn btn-danger">YA</a>
                      </form>
