      ...
      <nav class="navbar navbar-inverse col-md-12 col-sm-12 col-lg-12">
        <div class="container-fluid">
            <div class="navbar-header">
                <a id="menunavbar" class="navbar-brand" href="http://localhost/restaurant/Index.php">Home</a>
            </div>
            <ul class="nav navbar-nav">
              <li><a id="menunavbarnow" href="http://localhost/restaurant/DaftarMenu.php">Daftar Menu</a></li>
            </ul>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body mx-3">
                        ...
                        <div class="form-group">
                          <input type="email" name="email" id="email" class="form-control input-lg" placeholder="Email Anda">
                        </div>
                        <div class="form-group">
                          <input type="password" name="password" id="password" class="form-control input-lg" placeholder="Password">
                        </div>
                        <div class="form-group">
                          <select class="form-control input-lg" id="exampleFormControlSelect1" name="gender">
