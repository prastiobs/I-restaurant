      ...
      <nav class="navbar navbar-inverse col-md-12 col-sm-12 col-lg-12">
        <div class="container-fluid">
            <div class="navbar-header">
                <a id="menunavbarnow" class="navbar-brand" href="http://localhost/restaurant/IndexPelanggan.php">Home</a>
            </div>
            <ul class="nav navbar-nav">
              <li><a id="menunavbar" href="http://localhost/restaurant/PesanMakanan.php">Order Makanan</a></li>
